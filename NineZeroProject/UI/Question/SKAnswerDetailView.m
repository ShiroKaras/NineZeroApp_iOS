...
- (void)loadDataWithQuestionID:(NSString *)questionID {
	...
	[[[SKServiceManager sharedInstance] questionService] getQuestionAnswerDetailWithQuestionID:_quesitonID
											  callback:^(BOOL success, SKAnswerDetail *answerDetail) {
											      ...
											      [_headerImageView sd_setImageWithURL:[NSURL URLWithString:answerDetail.article_pic_1]
											      ...
											      if (answerDetail.article_Illustration_type == 0) {
												      ...
												      [_contentImageView sd_setImageWithURL:[NSURL URLWithString:answerDetail.article_Illustration_cover]
															   placeholderImage:[UIImage imageNamed:@"img_detailpage_default"]
																  completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
